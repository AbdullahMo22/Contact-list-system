...
exports.createDepartment = asynchandler(async (req, res) => {
    const { hotel_id, department_name } = req.body;
    const userAdd = req.user.id;
    
    const createdDepartment = await departmentService.createDepartment(hotel_id, department_name, userAdd, req.scope);
...
exports.updateDepartment = asynchandler(async (req, res) => {
    ...
    const updatedDepartment = await departmentService.updateDepartment(id, hotel_id, department_name, userUpdate, req.scope);
